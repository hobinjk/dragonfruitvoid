...
export interface InitOutput {
  ...
  readonly closure3351_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure3642_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure52229_externref_shim: (a: number, b: number, c: number) => void;
