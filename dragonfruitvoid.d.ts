...
export interface InitOutput {
  ...
  readonly closure3518_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure3809_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure52396_externref_shim: (a: number, b: number, c: number) => void;
