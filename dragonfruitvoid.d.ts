...
export interface InitOutput {
  ...
  readonly closure3355_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure3646_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure52233_externref_shim: (a: number, b: number, c: number) => void;
