...
export interface InitOutput {
  ...
  readonly closure3354_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure3645_externref_shim: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h36aa6ee6c843644b: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h167cd8db71805bce: (a: number, b: number) => void;
  readonly closure52232_externref_shim: (a: number, b: number, c: number) => void;
