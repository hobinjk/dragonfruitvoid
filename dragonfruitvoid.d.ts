...
export interface InitOutput {
  ...
  readonly closure3442_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure3733_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure52320_externref_shim: (a: number, b: number, c: number) => void;
