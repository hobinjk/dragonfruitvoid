...
export interface InitOutput {
  ...
  readonly closure3360_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure3651_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure52238_externref_shim: (a: number, b: number, c: number) => void;
