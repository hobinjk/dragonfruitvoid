...
export interface InitOutput {
  ...
  readonly closure3470_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure3761_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure52348_externref_shim: (a: number, b: number, c: number) => void;
