...
export function closure3470_externref_shim(a: number, b: number, c: number): void;
export function closure3761_externref_shim(a: number, b: number, c: number): void;
...
export function closure52348_externref_shim(a: number, b: number, c: number): void;
