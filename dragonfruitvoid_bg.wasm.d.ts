...
export function closure3355_externref_shim(a: number, b: number, c: number): void;
export function closure3646_externref_shim(a: number, b: number, c: number): void;
...
export function closure52233_externref_shim(a: number, b: number, c: number): void;
