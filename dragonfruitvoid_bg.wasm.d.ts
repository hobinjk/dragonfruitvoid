...
export function closure3354_externref_shim(a: number, b: number, c: number): void;
export function closure3645_externref_shim(a: number, b: number, c: number): void;
...
export function closure52232_externref_shim(a: number, b: number, c: number): void;
