...
export function closure3360_externref_shim(a: number, b: number, c: number): void;
export function closure3651_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h36aa6ee6c843644b(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h167cd8db71805bce(a: number, b: number): void;
export function closure52238_externref_shim(a: number, b: number, c: number): void;
