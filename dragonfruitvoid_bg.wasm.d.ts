...
export function closure3518_externref_shim(a: number, b: number, c: number): void;
export function closure3809_externref_shim(a: number, b: number, c: number): void;
...
export function closure52396_externref_shim(a: number, b: number, c: number): void;
