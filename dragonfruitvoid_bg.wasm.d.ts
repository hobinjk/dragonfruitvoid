...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb1a232bb112599b0(a: number, b: number): void;
export function closure3246_externref_shim(a: number, b: number, c: number, d: number): void;
export function closure3245_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7ad54ef130eca8f3(a: number, b: number): void;
export function closure69621_externref_shim(a: number, b: number, c: number): void;
