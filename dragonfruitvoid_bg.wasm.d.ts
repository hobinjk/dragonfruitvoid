...
export function closure3442_externref_shim(a: number, b: number, c: number): void;
export function closure3733_externref_shim(a: number, b: number, c: number): void;
...
export function closure52320_externref_shim(a: number, b: number, c: number): void;
