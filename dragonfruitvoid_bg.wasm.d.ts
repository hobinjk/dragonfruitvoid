...
export function closure3351_externref_shim(a: number, b: number, c: number): void;
export function closure3642_externref_shim(a: number, b: number, c: number): void;
...
export function closure52229_externref_shim(a: number, b: number, c: number): void;
